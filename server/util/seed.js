...
const transactions = [
  ...
  { amount: 23, date: Date.now(), type: 'expense', coordinates: [21, 22], description: 'description foo bar 41' },
  ...
  { amount: 1009, date: Date.now(), type: 'income', coordinates: [-23, 76], description: 'description foo bar 44' },
  ...
  { amount: 258, date: Date.now(), type: 'income', coordinates: [56, 2], description: 'description foo bar 47' },
  ...
  { amount: 5, date: Date.now(), type: 'expense', coordinates: [-71, -13], description: 'description foo bar 50' },
  ...
  { amount: 24.2, date: Date.now(), type: 'expense', coordinates: [-78, -15], description: 'description foo bar 62' },
  ...
  { amount: 99.9, date: Date.now(), type: 'expense', coordinates: [-77, -16], description: 'description foo bar 65' },
  ...
  { amount: 1.4, date: Date.now(), type: 'expense', coordinates: [-77, -19], description: 'description foo bar 68' },
  ...
  { amount: 11.78, date: Date.now(), type: 'expense', coordinates: [-74, -12], description: 'description foo bar 71' },
  ...
  { amount: 4.4, date: Date.now(), type: 'expense', coordinates: [-78, -12], description: 'description foo bar 74' },
  ...
  { amount: 5.6, date: Date.now(), type: 'expense', coordinates: [-77, -11], description: 'description foo bar 77' },
  ...
  { amount: 6, date: Date.now(), type: 'expense', coordinates: [-66, -12], description: 'description foo bar 80' },
  ...
  { amount: 76, date: Date.now(), type: 'expense', coordinates: [15, 12], description: 'description foo bar 83' },
