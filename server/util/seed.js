...
const categories = [
  { name: 'Salary', icon: 'account_balance', color: 'red' },
  { name: 'Food', icon: 'shopping_cart', color: 'pink' },
  { name: 'Packages', icon: 'local_shipping', color: 'purple' },
  { name: 'Shopping', icon: 'shopping_cart', color: 'indigo' },
  { name: 'Bar', icon: 'local_bar', color: 'blue' },
  { name: 'Business', icon: 'business', color: 'cyan' },
  { name: 'Car', icon: 'directions_car', color: 'teal' },
  { name: 'Public Transportation', icon: 'directions_bus', color: 'green' },
  { name: 'Restaurant', icon: 'restaurant', color: 'Lime' },
  { name: 'Movies', icon: 'theaters', color: 'light-green' },
  { name: 'Gas', icon: 'local_gas_station', color: 'light-blue' },
  { name: 'Cafe', icon: 'local_cafe', color: 'deep-purple' },
  { name: 'Taxi', icon: 'local_taxi', color: 'yellow' },
  { name: 'Hotel', icon: 'local_hotel', color: 'amber' },
  { name: 'Florist', icon: 'local_florist', color: 'orange' },
  { name: 'Golf', icon: 'golf_course', color: 'deep-orange' },
  { name: 'Fitness', icon: 'fitness_center', color: 'brown' },
  { name: 'Vacation', icon: 'beach_access', color: 'grey' },
  { name: 'Cigarette', icon: 'smoking_rooms', color: 'blue-grey' },
  { name: 'Board Games', icon: 'casino', color: 'black' },
  { name: 'School', icon: 'school', color: 'white' },
  { name: 'Baby', icon: 'child_care', color: 'red' },
  { name: 'Camera', icon: 'camera_alt', color: 'purple' },
  { name: 'Computer', icon: 'computer', color: 'yellow' },
  { name: 'Smartphone', icon: 'smartphone', color: 'green' },
  { name: 'Headset', icon: 'headset', color: 'grey' },
  { name: 'Health', icon: 'favorite', color: 'blue' },
  { name: 'Home', icon: 'home', color: 'black' },
  { name: 'Furniture', icon: 'weekend', color: 'teal' },
];
